...
var $frame = $('#main-photo');     // Container for image
var $subs = $('.sub');           // Thumbnails
...
$(document).on('click', '.sub', function(e){ // When a thumb is clicked on
  ...
  $subs.removeClass('active');          // Remove active from all thumbs
...
$('.sub').eq(0).click();                // Simulate click on first thumb